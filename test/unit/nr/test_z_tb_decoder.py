    ...
    def test_identity(self):
        ...
        for i, _ in enumerate(tb_sizes):
            encoder = TBEncoder(
                ...
                num_bits_per_symbol=num_coded_bits[i],
            ...
            decoder = TBDecoder(encoder=encoder, num_bp_iter=10, cn_type="minsum")
            ...
            self.assertTrue(torch.equal(crc_status, torch.ones_like(crc_status)))
