...
from comcloak.nr import CarrierConfig, PUSCHConfig, PUSCHTransmitter, PUSCHLSChannelEstimator
from comcloak.channel import RayleighBlockFading, OFDMChannel, AWGN
from comcloak.utils import insert_dims, flatten_last_dims
...
def check_channel_estimation(pusch_configs, add_awgn=False):
    ...
    if pusch_configs[0].precoding == "codebook":
        ...
        # Reshape to move channel matrix dimensions last
